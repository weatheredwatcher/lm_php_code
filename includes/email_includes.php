...
function getClients(){
	...
	$customer_email = trim($cus_row[15]);
	$customer_name = trim($cus_row[5]);
	$customer_first = trim($cus_row[7]);
	$customer_last = trim($cus_row[8]);
...
function getTemplate(){
	...
	*/
	...
	if($newrow[13] == ""){$bus_type = 200; $body_font = "Arial"; $webColorPri="C60651"; $webColorSec="636466"; $logo_1 = "logo1_puro";} //dwd 02/03/2010: added pri and sec color definitions
