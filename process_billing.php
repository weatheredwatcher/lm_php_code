...
$address1 = addslashes($data_array[$customer_index][10]);
$address2 = addslashes($data_array[$customer_index][11]);
...
//at this point the info from the two csv files should have been processed
...
mysql_query("INSERT INTO tbl_billing (clientID, billingCode, billingQuanity, month) VALUES('$client_id', '4', '1', '$month')")or die(mysql_error());

if ($webhosting == 1) {
mysql_query("INSERT INTO tbl_billing (clientID, billingCode, billingQuanity, month) VALUES('$client_id', '2', '1', '$month')")or die(mysql_error());
...
mysql_query("INSERT INTO tbl_billing (clientID, billingCode, billingQuanity, billingSubject, billingSubscriberList, month) VALUES('$client_id', '3', '$email_address', '$subject_human', '$subscriberList', '$month')")or die(mysql_error());
//bills for direct mail campaign
mysql_query("INSERT INTO tbl_billing (clientID, billingCode, billingQuanity, billingSubject, billingSubscriberList, month) VALUES('$client_id', '1', '$phys_address', '$subject_human', '$subscriberList', '$month')")or die(mysql_error());
...
echo ("<form name=\"billing\" method=\"post\" action=\"?id=write_billing\"><table border=1><tr><th>ClientID</th><th>Client Name</th><th>List File</th><th>Topic Code</th><th>NS Address Count</th><th>BackOffice Address Count</th><th>NS Email Count</th><th>BackOffice Email Count</th><th>Do you want to Correct the Count?</th><tr>");
while($row=mysql_fetch_row($results)){
	$emailCount = 0;
	$addressCount = 0;
